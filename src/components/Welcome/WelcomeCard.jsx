  ...
  return (
    <div className="w-full max-w-sm p-4 bg-white border border-gray-200 rounded-lg shadow sm:p-8">
      ...
      <p className="my-5">
        ...
        cumque a dolorem libero explicabo minima. Soluta earum non hic ea
        adipisci dolores! Quisquam animi saepe consequatur veniam accusantium
        temporibus ad facilis culpa suscipit ipsam. Eos asperiores laborum
        magni, minus quos ea repellendus qui tempora consequuntur, vero odio
        amet adipisci sint. Ipsum consequatur laudantium iste.
      </p>
